...
class StatuspageHookTests(WebhookTestCase):
    ...
    def test_statuspage_incident_created(self) -> None:
        ...
        self.send_and_test_stream_message('incident_created', expected_subject, expected_message, content_type="application/x-www-form-urlencoded")

    def test_statuspage_incident_update(self) -> None:
        expected_subject = u"Statuspage"
        expected_message = u"Incident Report :\n **Database query delays** \n * State: **resolved** \n * Description: The database issue is resolved."
        self.send_and_test_stream_message('incident_update', expected_subject, expected_message, content_type="application/x-www-form-urlencoded")
    ...
    def test_statuspage_component(self) -> None:
        ...
        self.send_and_test_stream_message('component_status_update', expected_subject, expected_message, content_type="application/x-www-form-urlencoded")
